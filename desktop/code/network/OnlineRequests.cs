        ...
        internal static async Task GetCurrentSatellite()
        {
            using (HttpClient client = new HttpClient()) 
            {
                ...
                try
                {
                    ...
                    EarthHologram.SatellitePoints.Add(CelestialMaths.ComputeECEFTilted(EarthHologram.Satellite.Latitude, EarthHologram.Satellite.Longitude) * (EarthHologram.HOLOGRAM_RADIUS + 0.1f)); // Compute XYZ coord.
